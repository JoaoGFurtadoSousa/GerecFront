...
export default function NovaTask() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const unidadesResponse = await fetch("http://192.168.0.101:8000/api/v1/unidades/", {
          headers,
        })
        ...
        const usuariosResponse = await fetch("http://192.168.0.101:8000/api/v1/usuarios/", {
          headers,
        })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.101:8000/api/v1/tarefas/", {
        method: "POST",
        headers,
        body: JSON.stringify({
